...
// Lokal auf den internen API-Route zeigen, sonst auf contact.php
...
const res = await fetch(API_URL, {
  ...
  body: JSON.stringify({
    ...
    website: form.website, // Honeypot-Feld
...
<span>Steinacker II 22, 76684 Östringen</span>
      ...
      <form onSubmit={handleSubmit} className="contact-form">
        ...
        {/* Honeypot-Feld (von Menschen unsichtbar) */}
